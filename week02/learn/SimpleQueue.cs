public class SimpleQueue {
    public static void Run() {
        ...
        // Fixed: Dequeue method now correctly accesses index 0 instead of index 1
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Fixed: 1) Enqueue now adds to the end for FIFO behavior, 2) Dequeue now accesses correct index
        ...
        // No defects found - this test case works correctly
    }
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // FIXED: Add to the end for FIFO behavior
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // FIXED: Access index 0 for FIFO behavior
        _queue.RemoveAt(0);
        return value;
    }
}