...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue returns people in wrong order (LIFO instead of FIFO), persons with exactly 1 turn left are not re-enqueued
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Queue returns people in wrong order (LIFO instead of FIFO), infinite turns (0) not handled correctly
    ...
    // Defect(s) Found: Queue returns people in wrong order (LIFO instead of FIFO), infinite turns (negative) not handled correctly
    ...
    // Defect(s) Found: None - this test should pass as the exception handling appears correct
